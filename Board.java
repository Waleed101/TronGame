...
public class Board extends JPanel
{
  ...
  // Grid colours
  private static final Color GRID_COLOR_A = new Color(13,20,30);
  private static final Color GRID_COLOR_B = new Color(13,20,40);
  
  // Preset colours for pieces
  private static final Color[] COLOURS = 
    {Color.YELLOW, Color.BLUE, Color.CYAN, Color.GREEN, 
     Color.PINK, Color.WHITE, Color.RED, Color.ORANGE, Color.darkGray, new Color(128,0,128), new Color(0,171,169), Color.GREEN, Color.RED, Color.GREEN, Color.CYAN, Color.YELLOW, Color.CYAN, Color.YELLOW, Color.RED, Color.GREEN, Color.RED, Color.GREEN, Color.RED, Color.GREEN};
  
  // String used to indicate each colour
  private static final String[] COLOUR_NAMES = 
  {"yellow", "blue", "cyan", "green", "pink", "white", "red", "orange", "darkgray", "purple", "teal", "greenP", "redR", "greenR", "cyanP1", "yellowP1", "cyanP2", "yellowP2", "redP1", "greenP1", "redP2", "greenP2", "redM", "greenM"};
